...
Below I am showing a linegraph that shows how the initial bankroll of \$100 developed after each game. The y-axis shows relative bankroll (that means it simply tallies wins and losses and sets the zero point at the intial bankroll). The bars at the bottom of the graph show how much was won or lost in each bet, and the size of the point indicates the amount of total stake that was wagered on each game. 
